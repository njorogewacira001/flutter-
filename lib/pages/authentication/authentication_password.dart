...
class FlexPageBody extends StatefulWidget {
  const FlexPageBody({Key? key}) : super(key: key);
...
class _FlexPageBodyState extends State<FlexPageBody> {
  ...
  void _navigateToDetailPage(int index) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DetailPage(widgetName: widgetName),
      ),
    );
  }
}
...
class DetailPage extends StatelessWidget {
  ...
  const DetailPage({required this.widgetName});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Detail page for $widgetName'),
      ),
    );
  }
}
